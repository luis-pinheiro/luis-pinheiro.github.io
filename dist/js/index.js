...
$(document).ready(function(){$('.button-collapse').sideNav({closeOnClick:true});$('.nav-link').click(function(){$('#navbarNav1').removeClass('show');});Tu.t_scroll({'t_element':".display-1 .slideDown",'t_duration':0.1,'t_delay':0.5,'t_function':'ease-in'});Tu.t_scroll({'t_element':'.lead .slideDown','t_duration':1,'t_delay':2,'t_function':'ease-in'})
